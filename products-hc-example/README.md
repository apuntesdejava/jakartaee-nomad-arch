...
`products-hc-example` is the products API used by the demo. It is a Quarkus JVM application built with Quarkus REST JSON-B, Hibernate ORM with Panache, and SmallRye Health.
